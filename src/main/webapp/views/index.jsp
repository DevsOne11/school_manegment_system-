...
<div class="section-bg style-1" style="color: #1d5987">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
...
<div class="section-bg style-1" style="background-color: #62bb7f">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="copyright">
                    <p>
                        ...
                        &copy;<script>document.write(new Date().getFullYear());</script>  Tashkent
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
            </div>
